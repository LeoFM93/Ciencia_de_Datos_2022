...
* En primer lugar, se crearon dos tablas con la suma de los montos transferidos para cada proyecto, una agrupada por regiones y el otro por código de provincia.
...
Finalmente, se creó un nuevo data frame integrando a nuestra base de datos con la información geográfica, las tablas con los montos transferidos por región y por provincia. 
...
ggplot(map_reg_01, aes(geometry=geometry)) +
  ...
  labs(title = "Gráfico 03. Montos Transferidos \n por Región") +
...
ggplot(map_prov_01, aes(geometry=geometry)) +
  ...
  theme_bw() +
  labs(fill = "soles") +
  labs(title = "Gráfico 04. Montos Transferidos \n por Provincia") +
  scale_fill_gradient (low="snow", high="orange")
...
ggplot(map_reg_02, aes(geometry=geometry)) +
  ...
  labs(title = "Gráfico 05. Participación de las Transferencias \n en el Monto de Inversión")+
...
ggplot(pb_reg2, aes(geometry=geometry)) +
  ...
  theme_bw() +
  labs(fill = "Porcentaje ")+
  labs(title = "GRAFICO 06. PORCENTAJE DE POBLACIÓN BENEFICIARIA \n POR REGIÓN")+  
  scale_fill_gradient (low="snow", high="orange")
